...
A Linear Regression ML model that predicts disease progression over 12 months, based on input features provided by doctors.

3. Defining success metrics

- Model generalises well to training data
- Model generalises well to testing data
- Model generalises well to new data (captured during operation)
